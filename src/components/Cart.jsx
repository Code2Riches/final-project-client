            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll mr-10 sm:mr-0 bg-white dark:bg-zinc-800 shadow-xl">
                    <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-10">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="ml-3 flex h-7 items-center">
                          <button
                            type="button"
                            className="-m-2 mr-0 p-2 text-gray-400 hover:text-gray-500"
